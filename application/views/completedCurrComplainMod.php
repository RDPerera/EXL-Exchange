...
<nav >
  <div class="item-image"><img src="<?php echo BASEURL; ?>/public/assets/img/icons/ee-logo.png" class="logo"></div>
   ...
   <a href="<?php echo BASEURL.'/moderatorDashboard/current' ?>"><div class="item selected"><img src="<?php echo BASEURL; ?>/public/assets/img/icons/icons8-complaint-90.png" class="sidebar-icons"><span>Current&nbspcomplains</span></div></a>
...
<div class="table-container">
  <p class="title">Current<span> Complains</span></p>
    <table >
      <tr>
        <th>Complain Id</th>
        <th>Complainant</th>
    ...
    <form action="<?php echo BASEURL; ?>/moderatorDashboard/approve" method="post">
  ...
  background-color: transparent;font-weight:500" ></td>
    ...
    <td><input type="submit" class="specialOne" value="Apply"></td>
    </tr>
      </form>
    <?php } ?>
    </table>
