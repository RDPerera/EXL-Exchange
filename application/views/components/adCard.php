...
echo"
        <div class='card'>
            <div class='card-top'>
                <a href='".BASEURL."/adverticement/".$row['advertisementID']."'><img src='".adIMG($row['image'])."' alt='Unsplash Photo'></a></div>
            <div class='card-content'>
                ...
                <a href='".BASEURL."/adverticement/".$row['advertisementID']."'><span class='title'>".$row['title']."</span></a>
                </div>
                <div class='bottom'>
