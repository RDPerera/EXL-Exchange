<?php
class sellerComplaint extends exlFramework
{
    ...
    {
            $complainerUsername =  $_POST['complainUser'];
            $accusedUsername =  $_POST['complainee'];
            $description=  $_POST['description'];
            $complainType=  $_POST['complainType'];
            $user = $this->model->insertComplain($complainerUsername,$accusedUsername,$description ,$complainType);
